...
import com.teamSweProject.repositories.MembershipRepository;
...
import com.teamSweProject.entities.Membership.MembershipType;
...
public class MembershipService {
    ...
    public Membership createMembership(Long userId, LocalDate expirationDate, MembershipType membershipType) {
        ...
        MembershipType defaultType = MembershipType.REGULAR_MEMBER; // Provide a default type
